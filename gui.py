...
class RecordSearchApp:
    def __init__(self, root):
        ...
        self.artists = ['100gecs', 'Ahmad Jamal Trio', 'Akoya Afrobeat Ensemble', 'Al Green', 'Amon Duul II', 'Art Blakey',
            ...
            'Bob Marley & The Wailers', 'Bobbi Humphrey', 'Bobby Hutcherson', 'Bobby Hutcherson', 'Bobby Hutcherson',
            ...
            'Jethro Tull', 'Jethro Tull', 'Joe Hisaishi', 'Joe Jackson', 'Joe Jackson', 'John Abercrombie', 'John Barry',
            ...
            'Masayoshi Takanaka', 'Masayoshi Takanaka', 'Matching Mole', 'McCoy Tyner', 'McCoy Tyner', 'Meco',
            ...
            'Soft Machine', 'Soft Machine', 'Soft Machine', 'Soft Machine', 'Sopwith Camel', 'Stan Getz & João Gilberto',
